        ...
        <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
          ...
          <div className="mt-6 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0">
            {callouts.map((callout) => {
              let src = "";
              if (callout.name.slice(0, 3) === "Men") {
                src =
                  "https://images.pexels.com/photos/10604607/pexels-photo-10604607.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2";
              } else {
                src =
                  ...
                  <div className="relative h-80 w-full overflow-hidden rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
                    ...
                    {callout.name.slice(0, 3) === "Men" ? (
                      ...
                      <img
                        ...
                        src={src}
                        className="h-full w-full object-cover object-center absolute"
                        onMouseEnter={() => setOpacity2(100)}
                        onMouseLeave={() => setOpacity2(0)}
                        style={{
                          opacity: opacity2,
                        }}
                      />
